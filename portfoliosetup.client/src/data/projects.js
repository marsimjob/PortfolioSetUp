...
export const projects = [
    ...
    },
    {
        ...
        details: "Complex sports statistics engine utilizing LINQ and Entity Framework for real-time data processing and domain-driven design.",
        images: [],
        highlights: ["LINQ", "Complex Backend Logic", "Entity Framework", "Data Manipulation"],
        languages: ["C#"],
        tools: ["EF Core", "LINQ", "DDD"],
    },
    {
        title: "Job Tracker",
